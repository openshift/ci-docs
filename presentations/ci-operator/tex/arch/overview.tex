    ...
    \begin{itemize}
        \item
            ...
            \begin{itemize}
                ...
                \item \href
                    {https://docs.ci.openshift.org/docs/architecture/ci-operator-internals/}
                    {/docs/architecture/ci-operator-internals}
                \item \href
                    {https://docs.ci.openshift.org/docs/architecture/ci-operator-internals/steps/}
...
\begin{frame}[fragile]
    \autotitle
    \url{https://docs.ci.openshift.org/docs/architecture/ci-operator-internals/steps/#step-types}
    \vspace{1em}
    \begin{itemize}
        \item build steps
        \item release steps
