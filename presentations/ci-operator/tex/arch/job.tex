...
\begin{frame}[fragile]
    \autotitle
    \footnotesize
    \url{https://github.com/openshift/release/blob/main/ci-operator/config/openshift/origin/openshift-origin-master.yaml}
    \normalsize
    \begin{verbatim}
tests:
- as: e2e-gcp
...
build_root:
  from_repository: true
    \end{verbatim}
    \small
    \url{https://github.com/openshift/origin/blob/main/.ci-operator.yaml}
    \normalsize
    \begin{verbatim}
build_root_image:
  name: release
...
\begin{frame}[fragile]
    \autotitle
    \footnotesize
    \url{https://github.com/openshift/release/blob/main/ci-operator/jobs/openshift/origin/openshift-origin-master-postsubmits.yaml}
    (simplified)
    \normalsize
    \begin{verbatim}
