...
\begin{frame}[fragile]
    \autotitle
    \href
        {https://github.com/openshift/release/blob/main/ci-operator/config/openshift/origin/openshift-origin-master.yaml}
        {ibid}
    \begin{verbatim}
- as: verify-deps
  ...
  container:
    ...
    \end{verbatim}
    \href
        {https://github.com/openshift/release/blob/main/ci-operator/config/openshift/origin/openshift-origin-release-3.11.yaml}
...
\begin{frame}[fragile]
    \autotitle
    \url{https://github.com/openshift/ci-tools/blob/main/pkg/api/types.go}
    \vfill
    \footnotesize
    \begin{verbatim}
...
\begin{frame}[fragile]
    \autotitle
    \url{https://github.com/openshift/release/tree/main/ci-operator/templates}
    \vfill
    \footnotesize
    \begin{verbatim}
...
\begin{frame}[fragile]
    \autotitle
    \href
        {https://github.com/openshift/release/blob/main/ci-operator/templates/openshift/installer/cluster-launch-installer-e2e.yaml}
