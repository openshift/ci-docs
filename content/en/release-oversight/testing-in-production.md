...
### Background
Like security, quality comes in layers.  In addition to the direct signal from our CI, [release gate testing](/architecture/release-gating/) and Quality Engineering, we're now testing our sprint output on a critical piece of our own infrastructure.
...
### Feedback
Two feedback loops are important to the success of this effort.  We covered the first in our [philosophy on failure](/release-oversight/testing-in-production/#our-philosophy-on-failure).  We refer to these internally as our *reaction plan*.
