...
The primary exception to this rule is when the [Technical Release Team](/release-oversight/the-technical-release-team) decides to enable the `/acknowledge-critical-fixes-only` label.
