...
[`tide`](https://docs.prow.k8s.io/components/core/tide/) in order to
[determine if jobs that are not managed by Prow should be considered merge
blocking](https://docs.prow.k8s.io/jobs#requiring-jobs-for-auto-merge-through-tide).
...
[upstream documentation.](https://docs.prow.k8s.io/components/optional/branchprotector/)
