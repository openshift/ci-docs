...
| [`build03`](https://console-openshift-console.apps.build03.ky4t.p1.openshiftapps.com/) | [registry.build03.ci.openshift.org](https://registry.build02.ci.openshift.org)                                       | contains up-to-date image copies from the authoritative registry for jobs that run on this build farm only                              |
