...
template-based tests and newer [multi-stage test workflows](/architecture/step-registry/).
...
in the previous step. Knowing how [multi-stage tests](https://docs.ci.openshift.org/architecture/step-registry/)
...
a [rehearsal run](https://docs.ci.openshift.org/how-tos/contributing-openshift-release/#rehearsals)
...
**Resolution:** Port the test to use [`$KUBEADMIN_PASSWORD_FILE`](/architecture/step-registry/#available-environment-variables) environmental variable instead.
