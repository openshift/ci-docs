...
[`ci-operator` documentation](/architecture/ci-operator#describing-inclusion-in-an-openshift-release).
...
is permitted to accessing the `Namespace` that run jobs provided that [GitHub is properly set up in Rover People](/getting-started/useful-links/#configure-github-in-rover-people).
