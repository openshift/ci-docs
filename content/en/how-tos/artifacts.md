...
- ["Life of a Prow Job"](https://docs.prow.k8s.io/life-of-a-prow-job/)
- ["Understanding Started.json and Finished.json"](https://docs.prow.k8s.io/metadata-artifacts/)
- ["Pod Utilities"](https://docs.prow.k8s.io/components/pod-utilities/)
{{< / alert >}}
...
"/internals/steps" >}}), not steps of a
[multi-stage test]({{< ref "/architecture/step-registry#step" >}}) &mdash;
...
- `build-resources`: this directory contains dumps of objects in the test
  ...
  "/how-tos/interact-with-running-jobs#how-and-where-do-the-tests-run" >}}),
...
- `test`: the name and contents of this directory varies based on the type of
  ...
  "/architecture/step-registry" >}}) tests, a separate directory underneath
