...
repositories are also supported with a few caveats. More information can be found [here](/architecture/private-repositories).
...
[Prow](https://docs.prow.k8s.io/overview/) is the k8s-native upstream CI system, source
...
[upstream.](https://docs.prow.k8s.io/components/plugins/approve/approvers/) You will also
...
[upstream.](https://docs.prow.k8s.io/jobs#how-to-configure-new-jobs)
...
[upstream](https://docs.prow.k8s.io/components/core/tide/config/).
...
doc](https://docs.prow.k8s.io/components/plugins/approve/approvers#approval-handler-and-the-approved-label)
on this topic.
...
doc](https://docs.prow.k8s.io/components/plugins/approve/approvers/#lgtm-label) on this
topic.
...
and a Prow job configuration that runs the test with `--target=$target`. Consult the [documentation](/architecture/ci-operator/#declaring-tests)
...
Information on how to publish images to an external registry can be found in a [separate document](/how-tos/mirroring-to-quay/).
...
It also requires [the approval of image names for mirroring](/how-tos/mirroring-to-quay/#mirroring-images).
