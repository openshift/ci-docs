...
option](https://docs.ci.openshift.org/architecture/ci-operator/#testing-with-an-existing-openshift-release).
...
ci-operator](https://docs.ci.openshift.org/how-tos/contributing-openshift-release/#variants)
